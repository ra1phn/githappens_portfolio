			...
			case "object": {
				...
				if (!pluginHandled) {
					...
					if (isArray) {
						...
						if (input2.size > 0) str[index2] = `["${TYPE_SET}",${[...input2].map((val) => flatten.call(this, val)).join(",")}]`;
						else str[index2] = `["${TYPE_SET}"]`;
					} else if (input2 instanceof Map) {
						if (input2.size > 0) str[index2] = `["${TYPE_MAP}",${[...input2].flatMap(([k, v]) => [flatten.call(this, k), flatten.call(this, v)]).join(",")}]`;
